...
BEGIN
  ...
  -- A page of the store's own (D54), linked from its footer.
  INSERT INTO commerce.pages (store_id, slug, draft, published, published_at)
  VALUES (v_store, 'om-oss', '{"title": "Om oss", "slug": "om-oss", "thumbnail": null, "seo": {"title": "", "description": "Kaizen Demo selger ting for hjem og kontor, laget for å vise hva Kaizen kan."}, "searchEngines": true, "aiAssistants": true, "categories": [], "tags": [], "rows": [{"id": "row-about", "type": "row", "layout": "1", "columns": [{"id": "column-about", "blocks": [{"id": "heading-about", "type": "heading", "text": "Om Kaizen Demo", "level": 1}, {"id": "text-about", "type": "richText", "doc": {"type": "doc", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "Vi selger ting for hjem og kontor. Butikken er laget for å vise hva Kaizen kan."}]}]}}]}]}]}'::jsonb, '{"title": "Om oss", "slug": "om-oss", "thumbnail": null, "seo": {"title": "", "description": "Kaizen Demo selger ting for hjem og kontor, laget for å vise hva Kaizen kan."}, "searchEngines": true, "aiAssistants": true, "categories": [], "tags": [], "rows": [{"id": "row-about", "type": "row", "layout": "1", "columns": [{"id": "column-about", "blocks": [{"id": "heading-about", "type": "heading", "text": "Om Kaizen Demo", "level": 1}, {"id": "text-about", "type": "richText", "doc": {"type": "doc", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "Vi selger ting for hjem og kontor. Butikken er laget for å vise hva Kaizen kan."}]}]}}]}]}]}'::jsonb, now());
