-- Demo catalogue: four clearly labelled sample products so the storefront has
-- something to show before real products exist. Safe to run more than once;
-- it does nothing if the demo manufacturer already exists.
--
...
DECLARE
  ...
  v_variant uuid;
BEGIN
  IF EXISTS (SELECT 1 FROM commerce.economic_operators WHERE name = 'Kaizen Demo AS') THEN
    RETURN;
  END IF;
  ...
  VALUES ('Kaizen Demo AS', 'Storgata 1, 0155 Oslo, Norge', 'sikkerhet@example.no', 'NO')
  RETURNING id INTO v_maker;

  INSERT INTO commerce.economic_operators (name, postal_address, electronic_address, country)
  VALUES ('Kaizen Demo AB', 'Drottninggatan 1, 111 51 Stockholm, Sverige', 'safety@example.se', 'SE')
  RETURNING id INTO v_rep;

  INSERT INTO commerce.inventory_locations (name, country)
  VALUES ('Lager Oslo', 'NO')
  RETURNING id INTO v_location;

  -- 1. Mug, two colours, with a genuine price reduction in Norway ------------
  INSERT INTO commerce.products (handle, manufacturer_id, responsible_person_id, tax_code)
  VALUES ('demo-keramikkopp', v_maker, v_rep, 'txcd_99999999')
  RETURNING id INTO v_product;

  INSERT INTO commerce.product_translations (product_id, locale, title, description, safety_information) VALUES
    (v_product, 'nb-NO', 'Demo: Keramikkopp',
    ...
    (v_product, 'sv-SE', 'Demo: Keramikmugg',
    ...
    (v_product, 'da-DK', 'Demo: Keramikkrus',
  ...
  INSERT INTO commerce.product_media (product_id, url, position, alt) VALUES
    (v_product, '/demo/mug.svg', 0,
     '{"nb-NO": "Hvit keramikkopp", "sv-SE": "Vit keramikmugg", "da-DK": "Hvidt keramikkrus"}');

  INSERT INTO commerce.product_schemes (product_id, scheme) VALUES (v_product, 'packaging');

  INSERT INTO commerce.product_variants (product_id, sku, gtin, options, weight_grams, hs_code, origin_country)
  VALUES (v_product, 'DEMO-MUG-WHITE', '7090000000011', '{"colour": "white"}', 380, '691200', 'PT')
  ...
  INSERT INTO commerce.inventory_levels (variant_id, location_id, on_hand) VALUES (v_variant, v_location, 40);

  INSERT INTO commerce.product_variants (product_id, sku, gtin, options, weight_grams, hs_code, origin_country)
  VALUES (v_product, 'DEMO-MUG-BLACK', '7090000000028', '{"colour": "black"}', 380, '691200', 'PT')
  RETURNING id INTO v_variant;
  PERFORM commerce.set_price(v_variant, 'NO', 29900, now() - interval '40 days');
  PERFORM commerce.set_price(v_variant, 'NO', 24900, now() - interval '1 day');
  PERFORM commerce.set_price(v_variant, 'SE', 24900, now() - interval '1 day');
  PERFORM commerce.set_price(v_variant, 'DK', 17900, now() - interval '1 day');
  INSERT INTO commerce.inventory_levels (variant_id, location_id, on_hand) VALUES (v_variant, v_location, 3);

  UPDATE commerce.products SET status = 'active' WHERE id = v_product;

  -- 2. Tote bag ---------------------------------------------------------------
  INSERT INTO commerce.products (handle, manufacturer_id, responsible_person_id, tax_code)
  VALUES ('demo-handlenett', v_maker, v_rep, 'txcd_99999999')
  RETURNING id INTO v_product;

  INSERT INTO commerce.product_translations (product_id, locale, title, description, safety_information) VALUES
    (v_product, 'nb-NO', 'Demo: Handlenett i lerret',
    ...
    (v_product, 'sv-SE', 'Demo: Tygkasse i canvas',
    ...
    (v_product, 'da-DK', 'Demo: Mulepose i lærred',
  ...
  INSERT INTO commerce.product_media (product_id, url, position, alt) VALUES
    (v_product, '/demo/tote.svg', 0,
     '{"nb-NO": "Naturfarget handlenett", "sv-SE": "Naturfärgad tygkasse", "da-DK": "Naturfarvet mulepose"}');

  INSERT INTO commerce.product_schemes (product_id, scheme) VALUES
    (v_product, 'packaging'), (v_product, 'textiles');

  INSERT INTO commerce.product_variants (product_id, sku, gtin, options, weight_grams, hs_code, origin_country)
  VALUES (v_product, 'DEMO-TOTE', '7090000000035', '{}', 180, '420222', 'IN')
  RETURNING id INTO v_variant;
  ...
  INSERT INTO commerce.inventory_levels (variant_id, location_id, on_hand) VALUES (v_variant, v_location, 120);

  UPDATE commerce.products SET status = 'active' WHERE id = v_product;

  -- 3. Notebook, two rulings --------------------------------------------------
  INSERT INTO commerce.products (handle, manufacturer_id, responsible_person_id, tax_code)
  VALUES ('demo-notatbok', v_maker, v_rep, 'txcd_99999999')
  RETURNING id INTO v_product;

  INSERT INTO commerce.product_translations (product_id, locale, title, description, safety_information) VALUES
    (v_product, 'nb-NO', 'Demo: Notatbok A5',
     'Trådinnbundet notatbok i A5 med 160 sider i 100 g papir.',
     ''),
    (v_product, 'sv-SE', 'Demo: Anteckningsbok A5',
     'Trådbunden anteckningsbok i A5 med 160 sidor i 100 g papper.',
     ''),
    (v_product, 'da-DK', 'Demo: Notesbog A5',
     'Trådindbundet notesbog i A5 med 160 sider i 100 g papir.',
     '');

  INSERT INTO commerce.product_media (product_id, url, position, alt) VALUES
    (v_product, '/demo/notebook.svg', 0,
     '{"nb-NO": "Blå notatbok", "sv-SE": "Blå anteckningsbok", "da-DK": "Blå notesbog"}');

  INSERT INTO commerce.product_schemes (product_id, scheme) VALUES (v_product, 'packaging');

  INSERT INTO commerce.product_variants (product_id, sku, gtin, options, weight_grams, hs_code, origin_country)
  VALUES (v_product, 'DEMO-NOTEBOOK-LINED', '7090000000042', '{"ruling": "lined"}', 300, '482010', 'NO')
  RETURNING id INTO v_variant;
  ...
  INSERT INTO commerce.inventory_levels (variant_id, location_id, on_hand) VALUES (v_variant, v_location, 60);

  INSERT INTO commerce.product_variants (product_id, sku, gtin, options, weight_grams, hs_code, origin_country)
  VALUES (v_product, 'DEMO-NOTEBOOK-DOTTED', '7090000000059', '{"ruling": "dotted"}', 300, '482010', 'NO')
  RETURNING id INTO v_variant;
  PERFORM commerce.set_price(v_variant, 'NO', 12900, now() - interval '1 day');
  PERFORM commerce.set_price(v_variant, 'SE', 12900, now() - interval '1 day');
  PERFORM commerce.set_price(v_variant, 'DK', 9900, now() - interval '1 day');
  INSERT INTO commerce.inventory_levels (variant_id, location_id, on_hand) VALUES (v_variant, v_location, 0);

  UPDATE commerce.products SET status = 'active' WHERE id = v_product;

  -- 4. Desk lamp, out of stock ------------------------------------------------
  INSERT INTO commerce.products (handle, manufacturer_id, responsible_person_id, tax_code)
  VALUES ('demo-bordlampe', v_maker, v_rep, 'txcd_99999999')
  RETURNING id INTO v_product;

  INSERT INTO commerce.product_translations (product_id, locale, title, description, safety_information) VALUES
    (v_product, 'nb-NO', 'Demo: Bordlampe',
    ...
    (v_product, 'sv-SE', 'Demo: Bordslampa',
    ...
    (v_product, 'da-DK', 'Demo: Bordlampe',
  ...
  INSERT INTO commerce.product_media (product_id, url, position, alt) VALUES
    (v_product, '/demo/lamp.svg', 0,
     '{"nb-NO": "Grønn bordlampe", "sv-SE": "Grön bordslampa", "da-DK": "Grøn bordlampe"}');

  INSERT INTO commerce.product_schemes (product_id, scheme) VALUES
    (v_product, 'packaging'), (v_product, 'electrical_equipment');

  INSERT INTO commerce.product_variants (product_id, sku, gtin, options, weight_grams, hs_code, origin_country)
  VALUES (v_product, 'DEMO-LAMP', '7090000000066', '{}', 1400, '940520', 'DK')
  RETURNING id INTO v_variant;
