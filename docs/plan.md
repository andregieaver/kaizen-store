...
| Email | EU-hosted email service (e.g. AWS SES eu-central-1) + React Email templates in the repo | Integrate | Resend (best DX, but **account data stays in the US**) ([Resend](https://resend.com/docs/dashboard/domains/regions)); Postmark (location unverified) | — |
